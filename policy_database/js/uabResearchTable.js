...
var APSAtable = (function () {
  ...
  //   'v2.2.3');
  var data_url ='https://script.google.com/macros/s/AKfycbwyLG_V8EOK7qI9eM12y79SwZg_5kxFqfDB4BpSYTCXSPTTxEs/exec'
  ...
  options = {
    visible: {
      ...
      Summary: wordSearch,
      Department: ["Anesthesiology", "Biochemistry & Molecular Genetics", "Biomedical Engineering", "Cell, Developmental, & Integrative Biology", "Dermatology", "Emergency Medicine", "Family & Community Medicine", "Genetics", "Medical Education", "Medicine", "Microbiology", "Neurobiology", "Neurology", "Neurosurgery", "Obstetrics & Gynecology", "Ophthalmology", "Otolaryngology", "Pathology", "Pediatrics", "Pharmacology & Toxicology", "Physical Medicine & Rehabilitation", "Psychiatric & Behavioral Neurobiology", "Radiation Oncology", "Radiology", "Surgery", "Urology", "Other"],
  ...
  filterMaker = function (cat, indexPercent) {
    var ret, i, changeFunc, mainFunc, innerRet, num, a, lis, text, textFiller, class_for_menu;
    lis = [];
